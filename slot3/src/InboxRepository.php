...
class InboxRepository
{
    ...
    /**
     * Tries to write a message to the inbox.
     * Returns true if successful (new message).
    ...
    /**
     * Deletes old entries from the inbox that were processed before a certain time.
     * $olderThanInterval is a SQL interval string, e.g., '-7 days'
     */
